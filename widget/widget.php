...
<div>
  ...
  <div class="wmail_button">
    <input class="wmail_textbox_button" name="wmail_txt_Button" id="wmail_txt_Button" onClick="return wmail_mail_ajax_submit('<?php echo mail_plugin_url('admin-ajax.php'); ?>')" value="<?php echo get_option('wmail_widget_but_cap'); ?>" type="button">
  </div>
</div>